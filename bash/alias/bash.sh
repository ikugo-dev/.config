...
abbrev-alias -g z="devour zaread"
abbrev-alias -g Z="find -type f -name '*.pdf' -exec devour zaread {} \;"
abbrev-alias -g f="devour feh"
abbrev-alias -g F="devour feh . -Z"
abbrev-alias -g Fr="devour feh . -Z -r"

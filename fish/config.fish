...
abbr --add cfgs "nvim ~/.config/setup-nixos.sh"
abbr --add cfgS "nvim ~/Code/Scripts"

abbr --add cfgn "nvim ~/.config/nixos/configuration.nix"
abbr --add cfgna "nvim ~/.config/nixos/audio-configuration.nix"
abbr --add cfgnb "nvim ~/.config/nixos/boot-configuration.nix"
abbr --add cfgnd "nvim ~/.config/nixos/display-configuration.nix"
abbr --add cfgnp "nvim ~/.config/nixos/package-configuration.nix"
